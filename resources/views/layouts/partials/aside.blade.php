                    ...
                    <div class="u-sidebar__content py-5">
                        ...
                        <ul class="list-unstyled font-size-14 mb-5">
                            <li>
                                <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                                    <img class="max-width-4 mr-3"
                                        src="{{ asset('assets/svg/components/finance-dark-icon.svg') }}"
                            ...
                            <li>
                                <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                                    <img class="max-width-4 mr-3"
                                        src="{{ asset('assets/svg/components/touch-dark-icon.svg') }}"
                                        alt="Image Description">
                                    <div class="media-body">
                                        <span>Activity</span>
                                    </div>
                            ...
                            <li>
                                <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                                    <img class="max-width-4 mr-3"
                                        src="{{ asset('assets/svg/components/team-dark-icon.svg') }}"
                                        alt="Image Description">
                                    <div class="media-body">
                                        <span>Team</span>
                                    </div>
                            ...
                            <li>
                                <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                                    <img class="max-width-4 mr-3"
                                        src="{{ asset('assets/svg/components/email-dark-icon.svg') }}"
                                        alt="Image Description">
                                    <div class="media-body">
                                        <span>Mailbox</span>
                                    </div>
                            ...
                            <li>
                                <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                                    <img class="max-width-4 mr-3"
                                        src="{{ asset('assets/svg/components/projects-dark-icon.svg') }}"
                                        alt="Image Description">
                                    <div class="media-body">
                                        <span>Projects</span>
                                    </div>
                        ...
                        <ul class="list-unstyled font-size-14 mb-0">
                            <li>
                                <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                                    <img class="max-width-4 mr-3"
                                        src="{{ asset('assets/svg/components/calendar-dark-icon.svg') }}"
                                        alt="Image Description">
                                    <div class="media-body">
                                        <span>Calendar</span>
                                    </div>
                            ...
                            <li>
                                <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                                    <img class="max-width-4 mr-3"
                                        src="{{ asset('assets/svg/components/cog-dark-icon.svg') }}"
                                        alt="Image Description">
                                    <div class="media-body">
                                        <span>Tools</span>
                                    </div>
                            ...
                            <li>
                                <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                                    <img class="max-width-4 mr-3"
                                        src="{{ asset('assets/svg/components/archive-dark-icon.svg') }}"
                                        alt="Image Description">
                                    <div class="media-body">
                                        <span>Archive</span>
                                    </div>
